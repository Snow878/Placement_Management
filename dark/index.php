...
<body>
    ...
    <div class="content" style="margin-top: 160px; margin-left: 10px;">
    	<h1 style="margin-left: 30px; font-size: 64px; color: white;">PLACEMENT <br><b> MANAGEMENT </b><br> SYSTEM</h1> <br>
      ...
      <div id="contact" style="z-index: 1; position: absolute; margin-left:2%; margin-top: 30vh;">
            <div class="form-row">
             <div class="form-group" style="margin-left:270px; margin-top: 200px;"> 
                <h1>Contact Us</h1>
                <p class="lead">&nbsp;<i class="fas fa-mobile"></i>&nbsp; (+91) 72 0422 9999</p>
                <p class="lead">&nbsp;<i class="fas fa-at"></i>&nbsp; eastpoint@gmail.com</p>
              </div>
